...
var script$1 = {
    ...
    watch: {
        selected: function selected(_selected) {
            this.$emit('node-select', this, _selected);
        },
    ...
    created: function created() {
        ...
        if (this.$parent) {
            this.$parent.$on('drop-disabled', function () {
                _this2.dropDisabled = true;
            });
            this.$parent.$on('drop-enabled', function () {
...
var __vue_inject_styles__$3 = function (inject) {
  if (!inject) return;
  inject("data-v-2d463e0a_0", { source: "\n.tree-view{text-align:left\n}", map: undefined, media: undefined });
};
/* scoped */
